...
engineScene.enter(function (ctx) {
    ...
    axios.get('http://36ab43a2.ngrok.io/processor/v1/userDetails/' + ctx.session.intent)
        .then(response => {
            if (response.data.exists === true) {
                ...
                axios.get('http://36ab43a2.ngrok.io/processor/v1/userIntents/' + ctx.session.contact_number)      // display default menu from the wasps using axios.get
                .then(response => {
