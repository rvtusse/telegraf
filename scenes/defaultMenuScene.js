...
function DefaultMenuKeyboard(menu) {
 ...
 axios.get('http://8cee9d9c.ngrok.io/processor/v1/userInt/' + ctx.session.contact_number + '/' + ctx.session.intent.text)      // display default menu from the wasps using axios.get
 .then(response => {
